	...
	public static void CtrlSaisiNumeroSecu(String ns) throws ExceptionSaisiNumeroSecu{
		...
		try {
			...
			throw new ExceptionSaisiNumeroSecu("Il faut saisir uniquement des chiffres");
																						...
																						//Controle saisie nom de l'agence
	public static void CtrlSaisiAgence(String ns) throws Exception{
		if(ns.length()<5)
		{
			throw new Exception("Le nombre de caractère est inférieur à 5");
		}
	}
