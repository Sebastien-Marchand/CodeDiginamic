 ...
 * 
 * Classe qui représente le menue afficher pour l'utilisateur
 * Permet de récupérer les saisies de l'utilisateur et de les traiter
 *
 */
public class Menus {
	...
	/**
	 * Méthode qui permet d'afficher les possibilité de l'application
	 * pour l'utilisateur
	 */
	...
	/**
	 * Permet de spécifier qu'elle donnée l'utilisateur souhaite enregistrer
	 */
